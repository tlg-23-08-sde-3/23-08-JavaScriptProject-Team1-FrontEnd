var luxon = (function (exports) {
            ...
            return listStuff(
                ...
                function () {
                    ...
                    if (!_this4.meridiemCache) {
                        ...
                        _this4.meridiemCache = [DateTime.utc(2016, 11, 13, 9), DateTime.utc(2016, 11, 13, 19)].map(
                            function (dt) {
    ...
    function durationToMillis(matrix, vals) {
        ...
        for (
            var _iterator = _createForOfIteratorHelperLoose(reverseUnits.slice(1)), _step;
    ...
    function hasInvalidTimeData(obj) {
        ...
        var validHour =
                integerBetween(hour, 0, 23) || (hour === 24 && minute === 0 && second === 0 && millisecond === 0),
